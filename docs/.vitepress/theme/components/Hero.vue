...
const installCommand = 'brew install ben182/chief/chief'
      ...
      <div class="hero-content">
        ...
        <div class="hero-row">
          ...
          <div class="hero-actions">
            <a :href="withBase('/guide/quick-start')" class="btn-primary">Get Started</a>
            <a href="https://github.com/ben182/chief" target="_blank" rel="noopener" class="btn-secondary">
